...
Download p4 client tool from here: \\lynx\TempData\TAG\codereview\p4_client_tool\windows\post-review2.7.xml
Put it in c:\codereview

Download \\lynx\TempData\TAG\codereview\rbtools-master.tar.gz
...
Go to http://10.5.89.2 and login under your user.
If user is not exist or you don't know user and password,
please contact me: Pavel.Susloparov@Five9.com.
...
They can find ll changelist request assign to them in http://10.5.89.2/dashboard/ 'to me' button.
